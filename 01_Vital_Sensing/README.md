...
<table style="width: 100%; text-align: center;">
  <tr>
    <td style="width: 33%; border: none;">
      <img src="./01_Breathing/img/img1.png" width="100%"/>
      <br/><sub>호흡 실험 환경</sub>
    </td>
    <td style="width: 33%; border: none;">
      <img src="./01_Breathing/img/img2.png" width="100%"/>
      <br/><sub>전체 페이즈 맵</sub>
    </td>
    <td style="width: 33%; border: none;">
      <img src="./01_Breathing/img/img3.png" width="100%"/>
      <br/><sub>타겟 위치(32번 Bin) 페이즈</sub>
    </td>
  </tr>
  <tr>
    <td style="width: 33%; border: none;">
      <img src="./01_Breathing/img/img4.png" width="100%"/>
      <br/><sub>레이더 파라미터 설정</sub>
    </td>
    <td style="width: 33%; border: none;">
      <img src="./01_Breathing/img/img5.png" width="100%"/>
      <br/><sub>레인지 스펙트로그램</sub>
    </td>
    <td style="width: 33%; border: none;">
      <img src="./01_Breathing/img/img6.png" width="100%"/>
...
## 구현 코드 안내
각 프로젝트의 /code 폴더에는 알고리즘의 세부 원리와 수식 설명이 주석으로 상세히 포함되어 있습니다.
* 호흡 측정 로직: Phase processing, BPM calculation
* 움직임 측정 로직: 2D FFT, Clutter suppression